...
const RecordDetialsHeader = ({ recordName }) => {
  return (
    <div className="grid w-full sm:grid-cols-2 sm:gap-6 lg:grid-cols-4">
      <div className="flex flex-col rounded-xl border bg-[#13131a] shadow-sm">
        ...
        <a
          ...
          rounded-b-xl border-t border-gray-200 px-4 py-3 
          text-sm text-gray-600 hover:bg-gray-50 md:px-5 
...
export default RecordDetialsHeader;
