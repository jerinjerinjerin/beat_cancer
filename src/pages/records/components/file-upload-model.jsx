...
const FileUploadModel = ({
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-slate-700 text-slate-300 dark:border-slate-700 dark:text-slate-300">
        <svg
      ...
      {uploading && (
        <IconProgress size={15} className="mr-3 h-7 text-white w-7 animate-spin" />
      )}
      {uploadSuccess && (
